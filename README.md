...
This tutorial assumes you have access to an Openstack installation. While Openstack is used for basic infrastructure requirements the lessons learned in this tutorial can be applied to  other platforms.
